...
INSERT INTO `bookmark` (`created_at`, `description`, `title`, `url`, `visible`, `category_id`, `user_id`, `tag_id`) VALUES (NOW(), "Google je pretrazivac", "Google", "http://www.google.com", true, 1, 1, 1);
INSERT INTO `bookmark` (`created_at`, `description`, `title`, `url`, `visible`, `category_id`, `user_id`, `tag_id`) VALUES (NOW(), "Reddit je diskusioni servis", "Reddit", "http://www.reddit.com", true, 3, 2, 1);
